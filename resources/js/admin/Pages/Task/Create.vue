...
const form = useForm({
    ...
    completed_at: props.item.completed_at ?? "",
});
    ...
    <AuthenticatedLayout>
        ...
        <Card>
            <form @submit.prevent="submit" class="mt-6 space-y-6">
                ...
                <SelectGroup label="Employee" v-model="form.employee_id" item-text="full_name" :items="employees"
                    :error-message="form.errors.employee_id" required />
